...
const drawArc = (data) => {
  ...
  const numberOfDayesWithPrecipitation = data.filter(d => d.total_precip_in > 0).length;
  const percentageDaysWithPrecipitation = Math.round(numberOfDayesWithPrecipitation / numberOfDays * 100);
